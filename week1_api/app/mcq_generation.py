...
try:
    ...
    print("The 'words' package is not found. Downloading now...")
    nltk.download('words')
    print("The 'words' package has been downloaded.")

try:
    find('corpora/punkt.zip')
except LookupError:
    print("The 'punkt' package is not found. Downloading now...")
    nltk.download('punkt')
    print("The 'punkt' package has been downloaded.")
    
try:
    find('corpora/maxent_ne_chunker.zip')
except LookupError:
    print("The 'maxent_ne_chunker' package is not found. Downloading now...")
    nltk.download('maxent_ne_chunker')
    print("The 'maxent_ne_chunker' package has been downloaded.")

try:
    find('corpora/averaged_perceptron_tagger.zip')
except LookupError:
    print("The 'averaged_perceptron_tagger' package is not found. Downloading now...")
    nltk.download('averaged_perceptron_tagger')
    print("The 'averaged_perceptron_tagger' package has been downloaded.")

try:
    find('corpora/stopwords.zip')
except LookupError:
    print("The 'stopwords' package is not found. Downloading now...")
    nltk.download('stopwords')
    print("The 'stopwords' package has been downloaded.")
